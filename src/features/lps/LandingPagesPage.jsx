      ...
      <div className="mx-auto max-w-6xl px-6 py-10 lg:py-16">
        <header className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white">Landing Pages</h1>
              <p className="mt-1 text-slate-600 dark:text-slate-300">Crie, edite e gerencie as páginas dos clientes.</p>
            </div>
            <button
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md dark:border-slate-800 dark:bg-slate-900">
            <h2 className="text-lg font-medium text-slate-900 dark:text-slate-100">Adicionar/Editar Landing Page</h2>
            <form onSubmit={onSubmit} className="mt-4 grid gap-4">
              <div className="grid gap-1.5">
                <label htmlFor="titulo" className="text-sm font-medium text-slate-700 dark:text-slate-200">Título</label>
                <input
                  id="titulo"
              ...
              <div className="grid gap-1.5">
                <label htmlFor="id_cliente" className="text-sm font-medium text-slate-700 dark:text-slate-200">Cliente</label>
              ...
              <div className="grid gap-1.5">
                <label htmlFor="id_template" className="text-sm font-medium text-slate-700 dark:text-slate-200">Template</label>
                <div className="relative">
                  <select
                    id="id_template"
                    className="h-11 w-full appearance-none rounded-lg border border-slate-300 bg-white px-3 pr-10 text-slate-900 outline-none ring-0 transition focus:border-sky-400 focus:ring-2 focus:ring-sky-200 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100 dark:focus:border-sky-500 dark:focus:ring-sky-700/40"
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-md dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-baseline justify-between">
              <h2 className="text-lg font-medium text-slate-900 dark:text-slate-100">Lista de Landing Pages</h2>
                  ...
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <div className="font-medium text-slate-900 dark:text-slate-100">{lp.titulo}</div>
                      </div>
                      <div className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                        Cliente: {clientesById[String(lp.id_cliente)]?.nome ?? "—"} · Template: {templateName(lp.id_template)}
                      </div>
                      <div className="mt-1 text-xs text-slate-500 dark:text-slate-400">ID: {lp.id}</div>
                    </div>
