        ...
        <header className="mb-8">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-between gap-2">
            <p className="text-slate-600 dark:text-slate-300">
              ...
              {user?.role ? (
                <span className="ml-2 rounded-full border border-slate-200 px-2 py-0.5 text-xs text-slate-600 dark:border-slate-700 dark:text-slate-300">
                  {user.role}
                </span>
              ) : null}
            </p>
        ...
        <section className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <svg
                className="mt-1 h-5 w-5 text-slate-400 transition group-hover:translate-x-0.5 group-hover:text-slate-600 dark:group-hover:text-slate-200"
                viewBox="0 0 20 20"
                fill="currentColor"
                aria-hidden="true"
              >
          ...
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                  Crie e edite páginas rapidamente.
                </p>
              </div>
              <svg
                className="mt-1 h-5 w-5 text-slate-400 transition group-hover:translate-x-0.5 group-hover:text-slate-600 dark:group-hover:text-slate-200"
          ...
          >
            ...
            <div className="relative flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
                  Acompanhe desempenho e conversões.
                </p>
              </div>
              <svg
                className="mt-1 h-5 w-5 text-slate-400 transition group-hover:translate-x-0.5 group-hover:text-slate-600 dark:group-hover:text-slate-200"
