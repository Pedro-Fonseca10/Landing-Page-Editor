            ...
            <div className="relative overflow-hidden rounded-2xl border bg-white/60 p-8 shadow-sm backdrop-blur dark:bg-slate-900/60">
              ...
              <div className="relative">
                ...
                <p className="mt-3 max-w-md text-slate-600 dark:text-slate-300">
                  Landing Page Editor - Acesse seu painel para gerenciar seus
                  projetos e acompanhar métricas em tempo real.
                </p>
          ...
          <main className="mx-auto w-full max-w-md">
            <div className="rounded-2xl border border-slate-200 bg-white/70 p-6 shadow-md backdrop-blur dark:border-slate-800 dark:bg-slate-900/60">
              ...
              {err && (
                <div
                  role="alert"
                  className="mb-4 flex items-start gap-3 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-800 dark:border-red-900/50 dark:bg-red-950/40 dark:text-red-200"
                >
                  <svg
              ...
              <form className="grid gap-4" onSubmit={onSubmit}>
                ...
                <button
                  type="submit"
                  className="mt-2 inline-flex h-11 w-full items-center justify-center rounded-lg bg-sky-600 px-4 font-medium text-white shadow-sm transition hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-300 disabled:opacity-50 dark:bg-sky-500 dark:hover:bg-sky-600 dark:focus:ring-sky-700/40"
                >
                  Entrar
                </button>
              </form>
